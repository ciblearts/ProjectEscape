...
var player = load("res://Playerdemo.tscn")
...
func _ready() -> void:
	...
	#Error calling method from signal 'network_peer_connected': 'KinematicBody2D(Player.gd)::_network_peer_connected': Method not found.
...
func _on_Join_server_pressed():
	if username_text_edit.text != "":
		...
		Global.instance_node(load("res://scenes/MainMenu/Server_browser.tscn"), self)
		print('join server pressed') #test
...
sync func switch_to_game() -> void:
	...
	get_tree().change_scene("res://Gamedemo.tscn")
